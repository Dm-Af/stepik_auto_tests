...
class TestMainPage1():
    ...
    @pytest.mark.smoke
    @pytest.mark.advanced_mark
    def test_guest_should_see_basket_link_on_the_main_page(self, browser):
        browser.get(link)
        browser.find_element(By.CSS_SELECTOR, ".basket-mini .btn-group > a")

# @pytest.mark.smoke и @pytest.mark.advanced_mark - декораторы, которые создают маркировку "mark" тестов,
# чтобы их оба можно было вызывать из консоли, такой командой:
# pytest -svm smoke lesson_3_5_2__PyTest_test_marking.py
#
# Чтобы вызвать только второй тест, нужно выполнить:
# pytest -svm "smoke and advanced_mark" lesson_3_5_3__PyTest_test_marking_2marks.py
#
